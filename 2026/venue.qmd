...
The *Residencia de Estudiantes*, located just a few steps from the Rocasolano Institute, is one of Spain’s most iconic cultural and scientific landmarks, linked to figures such as Lorca, Dalí, and Severo Ochoa. During the Iberian Prion Meeting 2026, we encourage all attendees to take advantage of its proximity and explore its historic gardens, buildings, and exhibitions. You can also enhance your visit using their official audio‑guide app, which offers a self‑guided tour of this unique space.
